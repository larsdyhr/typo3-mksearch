...
class tx_mksearch_util_Indexer
{
    ...
    {
        /** @var \TYPO3\CMS\Core\Utility\RootlineUtility $rootline */
        $rootline = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance(\TYPO3\CMS\Core\Utility\RootlineUtility::class, $pid);
        return $rootline->get();
